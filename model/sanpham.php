...
{
    $sql = "SELECT a.name_pro, COUNT(*) as count FROM product a INNER JOIN cart b ON a.id_pro = b.id_pro INNER JOIN bill c ON b.id_bill = c.id_bill WHERE c.status_pay = 1 GROUP BY a.name_pro ORDER BY count DESC";
    $listpro= pdo_query($sql);
    return $listpro;
}
