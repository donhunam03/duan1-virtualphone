        ...
        case 'viewbill':
            ...
            case 'contact':
                ...
                case 'history_bill':
                    ...
                    $public  = history_bill($_SESSION['user']['id_user']);
                require_once "view/giohang/history_bill.php";
                break;
                case 'detail_bill':
                 $public  = detail_bill($_GET['id']);
                 $public2  = detail_cart($_GET['id']);
                 require_once "view/giohang/detail_bill.php";
                 break;
                 case 'deleted_bill';
                     update_deleted($_GET['id']);
                     echo '<script>alert("Hủy đơn thành công!");</script>';
                     header('Location:?act=history_bill');
                 break;
                 case 'create_bill';
                      create_new($_GET['id']);
                      echo '<script>alert("Mua lại thành công!");</script>';
                      header('Location:?act=history_bill');
                 break;
                  case 'success_bill';
                      success_bill($_GET['id']);
                      echo '<script>alert("nhận hàng thành công!");</script>';
                      header('Location:?act=history_bill');
                      break;
                default:
