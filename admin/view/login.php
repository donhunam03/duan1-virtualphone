...
<head>
  ...
  <title>Virtual Phone - Login</title>
  <link rel="shortcut icon" type="imagex-icon" href="view/assets/img/logo-url.jpg" />
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Trang quản trị VirtualPhone!</h1>
                  </div>
