...
<head>
  ...
  <link rel="shortcut icon" type="./src/imagex-icon" href="./src/image/menu/logo/logo-url.jpg" />
   <link rel="stylesheet" type="text/css" media="screen" href="./src/css/customer.cart.css" />
  <style type="text/css">
    .error {
      margin-top: 6px;
      margin-bottom: 0;
