                        ...
                        <div class="info-box">
                            ...
                            <div class="entry">
                                <p><i class="fa fa-university" aria-hidden="true"></i>
                                    ...
                                    <br>
                                    <span style="padding-left: 25px;word-break: keep-all;">TpBank</span>
                                </p>
                            </div>
                            <div class="entry">
                                <p><i class="fa fa-credit-card" aria-hidden="true"></i>
                                    ...
                                    <br>
                                    <b id="copyStk" style="padding-left: 25px;word-break: keep-all;color:greenyellow;">70923969020</b>
                                    <i onclick="copy()" data-clipboard-target="#copyStk" class="fas fa-copy copy"></i>
                                </p>
                            </div>
                            <div class="entry">
                                <p><i class="fa fa-user" aria-hidden="true"></i>
                                    <span style="padding-left: 5px;">Tên tài khoản</span>
                                    <br>
                                    <span style="padding-left: 25px;word-break: keep-all;">NGUYEN VAN NAM</span>
                                </p>
                            </div>
                            <div class="entry">
                        ...
                        <div class="info-box">
                            ...
                            <div class="entry">
                                <p><i class="fa fa-credit-card" aria-hidden="true"></i>
                                    ...
                                    <br>
                                    <b id="copyStk" style="padding-left: 25px;word-break: keep-all;color:greenyellow;">0923969020</b>
                                    <i onclick="copy()" data-clipboard-target="#copyStk" class="fas fa-copy copy"></i>
                                </p>
                            </div>
                            <div class="entry">
