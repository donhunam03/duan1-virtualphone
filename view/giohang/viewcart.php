            ...
            <div class="col-12">
                <form action="index.php?act=bill" method="post">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="coupon-all">
                                <div class="coupon">
                                    <a href="?act=removecart"><input class="button" name="apply_coupon" value="Xóa toàn bộ sản phẩm" type="button"></a>
                                </div>
                                <div class="coupon2">
                                    <a href="?act=product"><input type="button" class="button" value="Xem thêm sản phẩm"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <?php } else { ?>
                        ...
                        <div class="wrap-btn-order mt-4">
                            <a href="?act=product" class="btn btn-secondary text-white"><i class="fa-solid fa-plus"></i> Thêm sản phẩm</a>
                        </div>
                    <?php } ?>
                    </div>
                </form>
