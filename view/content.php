        ...
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="banner-item">
                <a href="index.php?act=product">
                    <img src="./src/image/banner/oppo.png" alt="VirtualPhonr Product" />
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="banner-item">
                <a href="index.php?act=product">
                    <img src="./src/image/banner/realme.jpg" alt="VirtualPhone Product" />
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="banner-item">
                <a href="index.php?act=product">
                    <img src="./src/image/banner/samsung.jpg" alt="VirtualPhone Product" />
                </a>
            </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="banner-item">
                <a href="index.php?act=product">
                    <img src="./src/image/banner/xiaomi.png" alt="VirtualPhone Product" />
                </a>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-6">
                <div class="banner-item">
                    <a href="index.php?act=product&idcate=11">
                        <img src="./src/image/banner/poco.jpg" alt="VirtualPhone Product" />
                    </a>
                </div>
            </div>
            <div class="col-lg-6">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="banner-item">
                            <a href="index.php?act=product&idcate=8">
                                <img src="./src/image/banner/ipx.jpg" alt="VirtualPhone Product" />
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                            ...
                            <div class="col-lg-12">
                                <div class="banner-item">
                                    <a href="index.php?act=product&idcate=14">
                                        <img src="./src/image/banner/sony.jpg" alt="VirtualPhone Product" />
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="banner-item">
                                    <a href="index.php?act=product&idcate=11">
                                        <img src="./src/image/banner/blue.jpg" alt="VirtualPhone Product" />
                                    </a>
                                </div>
                            </div>
                        </div>
...
<!-- VirtualPhone Product Various Style Area End Here -->

<!-- Begin VirtualPhone Product With Content Area -->
<div class="mt-5 banner-with-content_area @@item-separation">
    <!-- Begin VirtualPhone Product Content Area -->
    <div class="jb-banner_content">
        ...
        <div class="product-desc" style="margin-top: 5px;">
            <p>
                Mua điện thoại iPhone 14, 14 Plus, 14 Pro, 14 Pro Max tại VirtualPhone. Trả Góp 0%. Thu cũ đổi mới giá tốt. Nhiều ưu đãi khủng. Chần chừ gì nữa mà không nhấc máy đặt hàng ngay?
            </p>
        </div>
...
<!--Banner sale --> 
<div class="jb-banner_area banner-two_columns mt-5">
    <div class="container">
        <div class="row g-0">
            <div class="col-lg-6">
                <div class="banner-item">
                    <a href="index.php?act=product&idcate=12">
                        <img src="./src/image/banner/banner-vsm.jpg" alt="VirtualPhone Product" />
                    </a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="banner-item">
                    <a href="index.php?act=product&idcate=11">
                        <img src="./src/image/banner/banner-xiaomi.jpg" alt="VirtualPhone Product" />
                    </a>
                </div>
            </div>
        </div>
