            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-4">
                    <div class="header-info_area">
                        <span>Chào mừng đến với VirtualPhone!</span>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-6 order-1 order-lg-1 order-sm-1">
                    <div class="hm-logo">
                        <a href="index.php">
                            <img src="./src/image/menu/logo/logo-url.jpg" width="50px" alt="Logo Virtualphone" />
                        </a>
                    </div>
                </div>
                    ...
                    <div class="hm-menu">
                        <nav>
                            <ul>
                                ...
                                <li>
                                    <a href="?act=history_bill">Đơn Hàng</a>
                                </li>
<!--                                <li>-->
            ...
            <div class="row">
                ...
                <div class="col-xl-2 col-lg-3 col-md-3">
                    <div class="contact-info">
                        <a href="tel://+84923969020"><i class="fa fa-phone-volume"></i> +84 923969020 </a>
                    </div>
                </div>
